 ...
 *@version 1.0
 */
public class ZxHomeworkAnswer extends BaseObject implements Serializable, Cloneable {
	...
	public boolean equals(Object other) {
		if (!(other instanceof ZxHomeworkAnswer))
		return false;
		ZxHomeworkAnswer castOther = (ZxHomeworkAnswer)other;
