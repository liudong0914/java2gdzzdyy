 ...
 *@version 1.0
 */
public class TkBookContentFilmWatch extends BaseObject implements Serializable, Cloneable {
	...
	public boolean equals(Object other) {
		if (!(other instanceof TkBookContentFilmWatch))
		return false;
		TkBookContentFilmWatch castOther = (TkBookContentFilmWatch)other;
