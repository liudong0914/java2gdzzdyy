package com.wkmk.pay.tencent.common;
...
public class Signature {
    ...
    public static String getSign(Map<String,Object> map){
        ...
        //Util.log("Sign Before MD5:" + result);
        result = MD5.MD5Encode(result).toUpperCase();
        //result = com.util.encrypt.MD5.getEncryptPwd(result).toUpperCase();
        //Util.log("Sign Result:" + result);
        return result;
    }
    ...
    public static boolean checkIsSignValidFromResponseString(String responseString) throws ParserConfigurationException, IOException, SAXException {
        ...
        //【提示】此验证很重要，经测试，此处的map值和APIUtil.getPrepayid中的map值不一样，但最终的md5值是一样的
