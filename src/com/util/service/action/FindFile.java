 ...
 * File Name:FindFile.java
 * Package Name:com.util.service.action
 * Date:2016-11-15上午9:10:22
...
/**
 * 根据文件名，去指定的路径目录下面查找文件
 * ClassName:FindFile <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason:	 TODO ADD REASON. <br/>
 * Date:     2016-11-15 上午9:10:22 <br/>
...
public class FindFile {
	 public static void main(String[] args) {// java程序的主入口处
	        File folder = new File("E:/工程/zyb/WebRoot/upload/unzip/");// 默认目录
	        String keyword = "0001_解析.doc";
