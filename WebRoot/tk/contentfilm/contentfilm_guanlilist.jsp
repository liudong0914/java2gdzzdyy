...
//提交表单
function postData(){
    document.pageForm.action = '/tkBookContentFilmAction.do?method=listguanli';
		document.pageForm.submit();
}
function editFilm(obj){
	document.pageForm.action = '/tkBookContentFilmAction.do?method=beforeUpdate1&objid='+obj;
	document.pageForm.submit();
}
...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="batchRecord('/tkBookContentFilmAction.do?method=delBatchRecord1', '您确定删除选中微课?')"><span class="icon_recycle">删除</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
...
<input type="hidden" value="<bean:write name="bookid"/>" name="bookcontentid" id="bookid"/>
</form>
  </body>
</html>
