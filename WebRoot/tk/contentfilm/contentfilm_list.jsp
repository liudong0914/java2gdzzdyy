...
//提交表单
function postData(){
    document.pageForm.action = '/tkBookContentFilmAction.do?method=list';
		document.pageForm.submit();
}
function editFilm(obj){
	document.pageForm.action = '/tkBookContentFilmAction.do?method=beforeUpdate&objid='+obj;
	document.pageForm.submit();
}
...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="batchRecord('/tkBookContentFilmAction.do?method=checkBatchRecord', '您确定审核通过选中微课?')"><span class="icon_reply">审核</span></a>
		<div class="box_tool_line"></div>
		<a href="javascript:;" onclick="batchRecord('/tkBookContentFilmAction.do?method=delBatchRecord', '您确定删除选中微课?')"><span class="icon_recycle">删除</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
