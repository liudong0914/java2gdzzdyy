 ...
 function detail(id){
  ...
  <body >
   <form name="pageForm" method="post"> 
    <div class="box3" panelTitle="${typetitle }" style="margin-right:0px;padding-right:0px;">
     <table>
      <tr>
       <td>题目编号：</td>
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="addRecord('/tkBookContentQuestionAction.do?method=unlist&bookid=${bookid}')"><span class="icon_add">新增</span></a>
		<div class="box_tool_line"></div>
		<a href="javascript:;" onclick="batchRecord('/tkBookContentQuestionAction.do?method=bathdelQuestions', '您确定移除选中题目?')"><span class="icon_delete">移除</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
