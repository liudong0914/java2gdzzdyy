...
//提交表单
function postData(){
    document.pageForm.action = '/tkBookContentFilmUploadAction.do?method=list';
		document.pageForm.submit();
}
function editFilm(obj){
	document.pageForm.action = '/tkBookContentFilmUploadAction.do?method=beforeUpdate&objid='+obj;
	document.pageForm.submit();
}
function addFilmPix(filmid){
  ...
  <body>
    ...
    <div class="box3" panelTitle="微课列表" style="margin-right:0px;padding-right:0px;">
     <table>
       <tr>
         <td>微课名称：</td>
...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="addRecord('/tkBookContentFilmUploadAction.do?method=beforeAdd')"><span class="icon_add">新增</span></a>
		<div class="box_tool_line"></div>
		<a href="javascript:;" onclick="batchRecord('/tkBookContentFilmUploadAction.do?method=delBatchRecord', '您确定删除选中微课?')"><span class="icon_recycle">删除</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
	...
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		...
		<tr>
			<td><input type="checkbox" name="checkid" value="<bean:write property="fid" name="model"/>" <c:if test="${model.status=='1' }">disabled="disabled"</c:if>/></td>
