		...
		<tr>
			...
			<td>
				...
				<logic:iterate id="t" name="typelist">
					<option value="${t.typeid}" ${typeid eq t.type?"selected":"" }>${t.typename}</option>
				</logic:iterate>
				</select>
			</td>
			<td>附件名称：</td>
			...
			<td>所属年份：</td>
			<td><input type="text" name="theyear" value="<bean:write name="theyear"/>"/></td>
...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="addRecord('/tkPaperFileAction.do?method=beforeAdd')"><span class="icon_add">新增</span></a>
...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		<tr>
			<th width="25"></th>
			<th class="ali02" width="100"><span onclick="sortHandler('status')" id="span_status">所属年份</span></th>
			<th class="ali02" width="160"><span onclick="sortHandler('typeno')" id="span_title">附件名称</span></th>
			<th class="ali02" ><span onclick="sortHandler('typename')" id="span_actor">文件类型</span></th>
			<th class="ali02" width="100"><span onclick="sortHandler('status')" id="span_status">所属地区</span></th>
			<th class="ali02" width="100"><span onclick="sortHandler('status')" id="span_status">所属分类</span></th>
		...
		<tr>
			...
			<td class="ali02">
		   <div class="img_edit0 hand" title="修改" onclick="editThisRecord('tk""PaperFileAction.do','<bean:write name="model" property="fileid"/>')"></div>	
			</td>
		</tr>
		</logic:iterate>
	</table>
