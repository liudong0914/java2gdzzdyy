...
<div class="box3" panelTitle="学员列表" style="margin-right:0px;padding-right:0px;">
	<table>
		<tr>
			<td>登录名：</td>
...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		...
		<tr>
			...
			<td class="ali02">
			<div class="img_find hand" style="margin-left:23px;" title="完成情况" onclick="completion(${model.userid})"></div>
			</td>
		</tr>
		</logic:iterate>
	</table>
...
<script type="text/javascript">
	...
	//提交表单
	function postData(){
	    document.pageForm.action = '/tkClassInfoAction.do?method=getStudents';
   		document.pageForm.submit();
	
	}
	
	function completion(userid){
	location.href="/tkClassInfoAction.do?method=completion&classid=${classid}&bookcontentid=${bookcontentid}&userid="+userid;
	}
</script>
</body>
</html>