...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		...
		<tr>
			...
			<td class="ali02">
			<div style="margin-left:20px;" class="img_user_group hand" onclick="getStudents(${classid},${model.bookcontentid})" title="学员列表"></div>
			</td>
		</tr>
		</logic:iterate>
	</table>
...
<script type="text/javascript">
	...
	//提交表单
	function postData(){
	    document.pageForm.action = '/tkClassInfoAction.do?method=getBookContentByClass';
   		document.pageForm.submit();
	
	}
	
	function getStudents(classid,bookcontentid){
		var diag = new top.Dialog();
		diag.Title = "学员列表";
		diag.URL = '/tkClassInfoAction.do?method=getStudents&classid='+classid+'&bookcontentid='+bookcontentid;
		diag.Width = 1000;
		diag.Height = 800;
