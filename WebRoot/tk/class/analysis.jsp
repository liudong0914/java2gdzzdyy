...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		...
		<tr>
			...
			<td class="ali02">
			<div style="margin-left:20px;" class="img_find hand" title="作业列表" onclick="getAnalysisBookcontents(${model.bookid},${model.classid })"></div>
			</td>
		</tr>
		</logic:iterate>
	</table>
...
<script type="text/javascript">
	...
	//提交表单
	function postData(){
	    document.pageForm.action = '/tkClassInfoAction.do?method=getAnalysis';
   		document.pageForm.submit();
	
	}
	
	function getAnalysisBookcontents(bookid,classid){
		var diag = new top.Dialog();
		diag.Title = "作业列表";
		diag.URL = '/tkClassInfoAction.do?method=getAnalysisBookcontents&bookid='+bookid+'&classid='+classid;
		diag.Width = 1000;
		diag.Height = 800;
