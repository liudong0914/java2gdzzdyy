...
<div class="box3" panelTitle="试卷分类管理" style="margin-right:0px;padding-right:0px;">
	<table>
		<tr>
			<td>分类编号：</td>
			...
			<td>分类状态：</td>
			<td><java2code:option name="status" codetype="status2" valuename="status" value="${status}"  selectall="1"/></td>
...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="addRecord('/tkPaperTypeAction.do?method=beforeAdd')"><span class="icon_add">新增</span></a>
		<div class="box_tool_line"></div>
		<a href="javascript:;" onclick="batchRecord('/tkPaperTypeAction.do?method=delBatchRecord', '您确定删除选中试卷分类?')"><span class="icon_delete">删除</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		<tr>
			<th width="25"></th>
			<th class="ali02" width="160"><span onclick="sortHandler('typeno')" id="span_typeno">分类编号</span></th>
			<th class="ali02"  ><span onclick="sortHandler('typename')" id="span_typename">分类名称</span></th>
			<th class="ali02" width="100"><span onclick="sortHandler('status')" id="span_status">分类状态</span></th>
		...
		<tr>
			...
			<td class="ali02">
			<java2code:value codetype="status2" property="status"></java2code:value>
			</td>
			<td class="ali02">
				<logic:empty name="model" property="flags">
		   			<div class="img_edit0 hand" title="修改" onclick="editThisRecord('tkPaperTypeAction.do','<bean:write name="model" property="typeid"/>')"></div>
		   		</logic:empty>	
			</td>
		</tr>
		</logic:iterate>
...
<script type="text/javascript">
	...
	//提交表单
	function postData(){
	    document.pageForm.action = '/tkPaperTypeAction.do?method=list';
