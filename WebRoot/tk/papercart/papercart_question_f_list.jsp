...
var tempvalue="1";
 ...
 function childrenQuestion(questionid){
 if (navigator.userAgent.indexOf('MSIE') >= 0 || navigator.userAgent.indexOf('rv:11') >= 0){
    window.showModalDialog("/tkPaperCartAction.do?method=childrenQuestionDetail&questionid="+questionid, "_blank", "dialogWidth=1200px;dialogHeight=750px");
   }else{
    window.open("/tkPaperCartAction.do?method=childrenQuestionDetail&questionid="+questionid,"_blank","heignt=750px,width=1200px");
   }
 }
</script>
     ...
     <div class="hd">
       ...
       <c:if test="${question.flags=='1' }">
            <div class="float2 btn">
              <a id="${question.questionid }children" onclick="childrenQuestion(${question.questionid})" class="btn_1" style="cursor: pointer;margin-right: 20px;">查看子题</a>
