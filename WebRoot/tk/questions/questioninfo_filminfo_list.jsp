...
var num=<bean:write name="pagelist" property="pageCount"/>
 function postData(){
   document.pageForm.action='/tkQuestionsInfoAction.do?method=filmInfo';
 ...
 function detail(filmid){
  ...
  <body>
   ...
   <div class="box3" panelTitle="已关联微课列表" style="margin-right:0px;padding-right:0px;">
    <table>
      <tr>
        <td>微课名称：</td>
...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="addRecord('/tkQuestionsInfoAction.do?method=unfilmInfo&questionid=${questionid}')"><span class="icon_add">新增</span></a>
		<div class="box_tool_line"></div>
		<a href="javascript:;" onclick="batchRecord('/tkQuestionsInfoAction.do?method=delBatchFilms', '您确定移除选中微课?')"><span class="icon_delete">移除</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
