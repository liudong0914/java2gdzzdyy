...
<script type="text/javascript">
  ...
  function postData(){
   document.pageForm.action='tkQuestionsInfoAction.do?method=unsimilarQuestion';
   document.pageForm.submit();
	...
	function saveRecord(){
	  document.pageForm.action='/tkQuestionsInfoAction.do?method=batchaddSimilarQuestions&questionid=${questionid}';
	  document.pageForm.submit();
	}
	function back(){
     ...
     document.getElementById("pageSize").value="10";
	  document.pageForm.action='/tkQuestionsInfoAction.do?method=similarQuestion&questionid=${questionid}';
	  document.pageForm.submit();
	}
  ...
  <body>
    ...
    <div class="box3" panelTitle="未关联题列表" style="margin-right:0px;padding-right:0px;">
     <table>
       <tr>
         <td>题目编号：</td>
         <td><input type="text"  name="questionno2" value="${questionno }"/> </td>
         <td>题目名称：</td>
         <td><input type="text"  name="title2" value="${title }"/> </td>
         <td>题目难度：</td>
         <td><java2code:option  name="difficult2" codetype="difficult" valuename="difficult" value="${difficult }"  selectall="1"/></td>
            <td>题目类型：</td>
            <td>
         <select name="type">
