...
<script type="text/javascript">
  ...
  function postData(){
   document.pageForm.action='tkQuestionsInfoAction.do?method=childrenlist';
  ...
  <body>
   ...
   <div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="addRecord('/tkQuestionsInfoAction.do?method=beforeAdd&questiontypeid=${questiontypeid}&subjectid=${subjectid }&parentid=${parentid }')"><span class="icon_add">新增</span></a>
		<div class="box_tool_line"></div>
		<a href="javascript:;" onclick="batchRecord('/tkQuestionsInfoAction.do?method=delBatchRecord', '您确定删除选中题目?')"><span class="icon_delete">删除</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
	...
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		...
		<tr>
			<td><input type="checkbox" name="checkid" value="<bean:write property="questionid" name="model"/>" <bean:write property="flags" name="model"/>/></td>
