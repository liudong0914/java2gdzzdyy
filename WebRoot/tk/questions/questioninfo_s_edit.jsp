...
<body>
	<div>
		<div class="box1" position=center>
          ...
          <td class="ali01">
           <input type="radio" value="1" name="tkQuestionsInfo.isrightans"/>是
           <input type="radio" value="0" name="tkQuestionsInfo.isrightans"/>否
          </td>
         </tr>
					<tr>
						<td class="ali03">正确答案：</td>
						<td class="ali01"><textarea id="rightns"
								name="tkQuestionsInfo.rightans"
								style="width: 670px;height: 230px;visibility: hidden;"><%=htmlspecialchars(model.getRightans())%></textarea>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="ali01"><input type="text"
							name="tkQuestionsInfo.score" value="${model.score }"
							class="validate[required,custom[onlyNumberWide]]" /></td>
					</tr>
					<tr>
