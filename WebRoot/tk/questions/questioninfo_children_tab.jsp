...
$(function(){ 
 ...
 function jump(id){
  ...
  ifarme.src="/tkQuestionsInfoAction.do?method=childrenlist&id=${parentid}&questiontypeid="+id;
 }
</script>
</head>
  ...
  <body>
   ...
   <div>
      ...
      <IFRAME scrolling="auto" width="100%" height="100%" frameBorder=0 id=subjectFrame name=subjectFrame onload="SetCwinHeight('subjectFrame', 510)" src="/tkQuestionsInfoAction.do?method=childrenlist&id=${parentid }&questiontypeid=${questiontypeid}" allowTransparency="true"></IFRAME>
    </table>
   </div>
   </div>
  </body>
