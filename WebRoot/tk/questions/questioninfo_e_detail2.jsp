...
<script type="text/javascript">
 ...
 function addRow(){
  ...
  var result="${model.rightans}";
  var shuzuresult=result.split("【】");
  for(var i=1;i<=num;i++){
     var nrow=3+i;
     ...
     var newTd1=newTr.insertCell(1);
      ...
      newTd1.innerHTML=shuzuresult[i-1];
   }
   var begin=document.getElementById("begin").rowIndex;
   var score="${model.score}";
   var shuzuscore=score.split("【】");
   for(var i=1;i<=num;i++){
    var nrow=begin+i;
     var newTr=tb.insertRow(nrow);
     var  newTd0=newTr.insertCell(0);
     var newTd1=newTr.insertCell(1);
      ...
      newTd1.className="ali01";
      newTd1.innerHTML=shuzuscore[i-1];
   }
 } 
  ...
  <body>
    ...
    <table id="testTab" class="tableStyle" formMode="line" align="center">
     ...
     <tr>
      <td class="ali03">题目编号：</td>
      <td class="ali01">${model.questionno }</td>
     </tr>
     <tr>
