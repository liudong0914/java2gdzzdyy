...
$(function(){
 ...
 document.getElementById("tkQuestionsInfo.option10").style.display="";
  ...
  var shuzu=rights.split("");
  for(var j=0;j<shuzu.length;j++){
   for(var i=0;i<radios.length;i++){
     if(radios[i].value==shuzu[j]){
...
function saveRecord(){
 ...
 function changeValue(temp){
  if(!temp.checked){
     var str=document.getElementById("rightans").value;
     var index=str.indexOf(temp.value);
     if(index==0){
     ...
     document.getElementById("rightans").value=str;
   }else if(document.getElementById("rightans").value!=""){
     if(document.getElementById("rightans").value.indexOf(temp.value)<0){
     var s=document.getElementById("rightans").value+","+temp.value;
     var shu=s.split(",");
     document.getElementById("rightans").value=shu.sort();
     }
   }else if(document.getElementById("rightans").value==""){
   ...
   <div>
      ...
      <html:form action="/tkQuestionsInfoAction.do" method="post">
       ...
       <tr id="tkQuestionsInfo.option1">
        <td><input type="checkbox" name="tkQuestionsInfo.rightans" value="A" ondblclick="changeValue(this);" onclick="changeValue(this);"  />选项A：</td>
        <td><textarea name="tkQuestionsInfo.option1" style="width:670px;height:230px;visibility:hidden;"><%=htmlspecialchars(model.getOption1())%></textarea></td>
       </tr>
       <tr id="tkQuestionsInfo.option2">
        <td><input type="checkbox" name="tkQuestionsInfo.rightans" value="B" ondblclick="changeValue(this);" onclick="changeValue(this);"  />选项B：</td>
        <td><textarea name="tkQuestionsInfo.option2" style="width:670px;height:230px;visibility:hidden;"><%=htmlspecialchars(model.getOption2())%></textarea></td>
       </tr>
       <tr id="tkQuestionsInfo.option3">
        <td><input type="checkbox" name="tkQuestionsInfo.rightans" value="C" ondblclick="changeValue(this);" onclick="changeValue(this);"  />选项C：</td>
        <td><textarea name="tkQuestionsInfo.option3" style="width:670px;height:230px;visibility:hidden;"><%=htmlspecialchars(model.getOption3())%></textarea></td>
       </tr>
       <tr id="tkQuestionsInfo.option4">
        <td><input type="checkbox" name="tkQuestionsInfo.rightans" value="D" ondblclick="changeValue(this);" onclick="changeValue(this);"  />选项D：</td>
        <td><textarea name="tkQuestionsInfo.option4" style="width:670px;height:230px;visibility:hidden;"><%=htmlspecialchars(model.getOption4())%></textarea></td>
       </tr>
       <tr id="tkQuestionsInfo.option5">
        <td><input type="checkbox" name="tkQuestionsInfo.rightans" value="E" ondblclick="changeValue(this);" onclick="changeValue(this);"  />选项E：</td>
        <td><textarea name="tkQuestionsInfo.option5" style="width:670px;height:230px;visibility:hidden;"><%=htmlspecialchars(model.getOption5())%></textarea></td>
       </tr>
       <tr id="tkQuestionsInfo.option6">
        <td><input type="checkbox" name="tkQuestionsInfo.rightans" value="F" ondblclick="changeValue(this);" onclick="changeValue(this);"  />选项F：</td>
        <td><textarea name="tkQuestionsInfo.option6" style="width:670px;height:230px;visibility:hidden;"><%=htmlspecialchars(model.getOption6())%></textarea></td>
       </tr>
       <tr id="tkQuestionsInfo.option7">
        <td><input type="checkbox" name="tkQuestionsInfo.rightans" value="G" ondblclick="changeValue(this);" onclick="changeValue(this);"  />选项G：</td>
        <td><textarea name="tkQuestionsInfo.option7" style="width:670px;height:230px;visibility:hidden;"><%=htmlspecialchars(model.getOption7())%></textarea></td>
       </tr>
       <tr id="tkQuestionsInfo.option8">
        <td><input type="checkbox" name="tkQuestionsInfo.rightans" value="H" ondblclick="changeValue(this);" onclick="changeValue(this);"  />选项H：</td>
        <td><textarea name="tkQuestionsInfo.option8" style="width:670px;height:230px;visibility:hidden;"><%=htmlspecialchars(model.getOption8())%></textarea></td>
       </tr>
       <tr id="tkQuestionsInfo.option9">
        <td><input type="checkbox" name="tkQuestionsInfo.rightans" value="I" ondblclick="changeValue(this);" onclick="changeValue(this);"  />选项I：</td>
        <td><textarea name="tkQuestionsInfo.option9" style="width:670px;height:230px;visibility:hidden;"><%=htmlspecialchars(model.getOption9())%></textarea></td>
       </tr>
       <tr id="tkQuestionsInfo.option10">
        <td><input type="checkbox" name="tkQuestionsInfo.rightans" value="J" ondblclick="changeValue(this);" onclick="changeValue(this);"  />选项J：</td>
        <td><textarea name="tkQuestionsInfo.option10" style="width:670px;height:230px;visibility:hidden;"><%=htmlspecialchars(model.getOption10())%></textarea></td>
       </tr>
       <tr id="over">
       <td class="ali03">正确答案：</td>
       <td class="ali01"><input type="text" id="rightans" readonly="readonly" value="${model.rightans }" name="rightans"/></td>
       </tr>
       <tr >
