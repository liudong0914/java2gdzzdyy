  ...
  <body>
    ...
    <html:form action="/tkQuestionsInfoAction.do" method="post">
      <table  class="tableStyle" formMode="line" align="center">
       ...
       <td class="ali01">
        <input type="radio" name="tkQuestionsInfo.rightans" value="1"/>正确
        <input type="radio" name="tkQuestionsInfo.rightans" value="0"/>错误
       </td>
       </tr>
       <tr>
