 ...
 function previewPic(piv,url){
  ...
  <div>
    ...
    <table id="testTab" class="tableStyle" formMode="line" align="center">
     ...
     <td class="ali01">${model.optionnum }个</td>
     </tr>
      <tr id="option1" >
     <td class="ali03" >选项A：</td>
     <td class="ali01">${model.option1}</td>
     </tr>
     <tr id="option2">
     <td class="ali03">选项B：</td>
     <td class="ali01">${model.option2}</td>
     </tr>
     <tr id="option3" >
     <td class="ali03" >选项C：</td>
     <td class="ali01">${model.option3}</td>
     </tr>
     <tr id="option4" >
     <td class="ali03" >选项D：</td>
     <td class="ali01">${model.option4}</td>
     </tr>
     <tr id="option5" >
     <td class="ali03">选项E：</td>
     <td class="ali01">${model.option5}</td>
     </tr>
     <tr id="option6" >
     <td class="ali03" >选项F：</td>
     <td class="ali01">${model.option6}</td>
     </tr>
     <tr id="option7" >
     <td class="ali03" >选项G：</td>
     <td class="ali01">${model.option7}</td>
     </tr>
     <tr id="option8" >
     <td class="ali03" >选项H：</td>
     <td class="ali01">${model.option8}</td>
     </tr>
     <tr id="option9" >
     <td class="ali03" >选项I：</td>
     <td class="ali01">${model.option9}</td>
     </tr>
     <tr id="option10"  >
     <td class="ali03" >选项J：</td>
     <td class="ali01">${model.option10}</td>
     </tr>
     <tr>
     ...
     <td class="ali01">${gradeName }</td>
     </tr>
     <tr>
     <td class="ali03">知识点：</td>
     <td class="ali01">${knopointnames }</td>
     </tr>
     <tr>
