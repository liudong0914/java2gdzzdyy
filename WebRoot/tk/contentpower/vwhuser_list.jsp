...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		...
		<tr>
			...
			<c:if test="${type=='3' }">
			<div style="margin-left: 20px;" class="img_user_worker hand" title="解题微课授权" onclick="bookcontentcheck3('<bean:write name="model" property="userid"/>',3)"></div>
			</c:if>
			</td>
		</tr>
		</logic:iterate>
...
<script type="text/javascript">
	...
	//提交表单
	function postData(){
	    document.pageForm.action = '/tkBookContentPowerAction.do?method=vwhuserlist';
	...
	function bookcontentcheck3(userid,type){
		 var diag=new top.Dialog();
		 diag.Title="解题微课授权";
		 diag.URL='/tkBookContentPowerAction.do?method=contentMain&userid='+userid+'&type='+type;
		 diag.Width=1000;
