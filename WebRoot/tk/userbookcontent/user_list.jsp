...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		...
		<tr>
			...
			<td class="ali02">
			<div style="margin-left:20px;" class="img_user_worker hand" title="授权" onclick="bookContentMain('<bean:write name="model" property="userid"/>')"></div>
			</td>
		</tr>
		</logic:iterate>
	</table>
...
<script type="text/javascript">
	...
	//提交表单
	function postData(){
	    document.pageForm.action = '/tkUserBookContentAction.do?method=userList';
   		document.pageForm.submit();
	
	}
	
	function bookContentMain(userid){
		var diag = new top.Dialog();
		diag.Title = "作业本内容授权";
		diag.URL = '/tkUserBookContentAction.do?method=bookContentMain&userid='+userid;
		diag.Width = 1000;
		diag.Height = 800;
