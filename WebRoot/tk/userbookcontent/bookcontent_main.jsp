     ...
     <td class="ver01">
        <div class="box3" overflow="hidden" showStatus="false" panelTitle="树列表">
			 	<div class="cusBoxContent" id="cusBoxContent" style="width:280px;">
			  		<IFRAME scrolling="auto" width="100%" height="100%" frameBorder=0 id=rfrmleft name=rfrmleft src="/tkUserBookContentAction.do?method=tree&userid=${userid}" allowTransparency="true"></IFRAME>
			  	</div>
		</div>
