...
function ckplayerConfig() {
	return {
		...
		config: {
			...
			loadNext: 3, //多段视频预加载的段数，设置成0则全部加载
			definition: true, //是否使用清晰度组件
			smartRemove: true, //是否使用智能清理，使用该功能则在多段时当前播放段之前的段都会被清除出内存，减少对内存的使用
			bufferTime: 1200, //缓存区的长度，单位：毫秒,不要小于100
		...
		menu: { //版权名称支持
			ckkey: '581f427b0ee064edf67517fd78ac06aa',
			name: '北京师科阳光信息技术有限公司',
			link: 'http://www.skyg.cn',
			version: 'X',
			domain: '',
			more: []
		},
	...
	ckplayer.prototype = {
		...
		*/
		...
		contextMenu: [
			['北京师科阳光信息技术有限公司', 'link', 'http://www.skyg.cn'],
			['version:X', 'default'],
