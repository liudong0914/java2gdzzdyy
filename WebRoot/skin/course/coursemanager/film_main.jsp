			...
			<tr>
				...
				<td class="ver01" style="position: relative;">
					<div class="box3" overflow="hidden" showStatus="false" panelTitle="树列表" style="margin-top:0px; position: absolute; top: 0px">
					 	<div class="cusBoxContent" id="cusBoxContent" style="width:180px;">
					  		<IFRAME scrolling="auto" width="100%" height="100%" frameBorder=0 id=rfrmleft name=rfrmleft onload="SetCwinHeight('rfrmleft', 680)" src="/eduCourseFilmAction.do?method=filmTree" allowTransparency="true"></IFRAME>
					  	</div>
				  	</div>
				</td>
				<!--左侧区域end-->
				...
				<td width="80%" class="ver01" >
					<div id="rfrmrightContent" style="margin: 0;padding: 0 5px 0 0;">
						<IFRAME scrolling="auto" width="100%" height="100%" frameBorder=0 id=rfrmright name=rfrmright onload="SetCwinHeight('rfrmright', 680)" src="/sysLayoutAction.do?method=welcome" allowTransparency="true"></IFRAME>
					</div>
				</td>
				<!--右侧区域end-->
			</tr>
