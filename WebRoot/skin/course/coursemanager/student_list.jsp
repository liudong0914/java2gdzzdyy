...
function postData(){
    document.pageForm.action = "/eduCourseUserAction.do?method=studentList";
...
function viewStudent(courseuserid){
    document.pageForm.action = "/eduCourseUserAction.do?method=viewStudent&courseuserid="+courseuserid;
  	document.pageForm.submit();
}
...
function selectUser(){
	...
	diag.Title = "选择学员";
	diag.URL = '/eduCourseUserAction.do?method=selectUser';
	diag.Width = 400;
	diag.Height = 500;
	...
	<div class="mainBox">
		...
		<div class="mainCon mainCon01">
			<div class="tab">
				...
				%>
				<div class="acts">
					<input class="btn btn-pop ml20" value="新增" onclick="addRecord('/eduCourseUserAction.do?method=beforeAddStudent')" style="display:inline-block;" type="button">
					<input class="btn btn-pop ml20" value="删除" onclick="delRecord('/eduCourseUserAction.do?method=delBatchRecordStudent')" type="button">
					<input class="btn btn-pop ml20" value="导入" onclick="selectUser()" type="button">
				</div>
				<%} %>
			</div>
						...
						<div class="tableBox box02">
							<table width="100%" style="border-collapse:separate;">
								...
								<tr>
									...
									<th width="60">
										<a class="alink" href="#"  onclick="viewStudent('<%=ecu.getCourseuserid() %>')">查看</a>
									</th>
								</tr>
								</thead>
							</table>
