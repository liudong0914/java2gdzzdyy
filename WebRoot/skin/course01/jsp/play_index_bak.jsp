            ...
            <div class="Course_play_bf_main">
            	...
            	<div style="width:100%; height:100%; background-color:#fff;">
					...
					<script type="text/javascript">
						var flashvars={
							/* f:'/course.bo?method=url%26vid=${playid}', */
							f:'/ckplayer/ckplayer/encrypt.swf',
					        fid:'${playid}',
					        fdm:'${fdm}',
							/* s:'1',
							c:'0',
						...
						var video=['/course.bo?method=url&vid=${playid}->ajax/get/utf-8'];
						CKobject.embed('/ckplayer/ckplayer/ckplayer.swf','a1','ckplayer_a1','100%','100%',false,flashvars,video,params);
					</script>
            	</div>
            	<%}else{ %>
            	<div class="Code">
