...
<div class="personal">
    ...
    <div class="information_right">
        ...
        <div class="information_right_main teacher_main">
            ...
            <div class="information_right_main_02">
             ...
             <div class="information_right_main_02">
                ...
                <logic:notEmpty name="model" property="filepath">
                	<logic:equal value="updateSaveTwo" name="act">
						<div id="docfileview">
							<input  type="button" class="btn_text2" id="btn_save" name="btn_save" onclick="javascript:doUpload('doc')" value="重新上传" />
							<p>已经上传附件，如需更新，请重新上传！</p>
						</div>
					</logic:equal>
					<div id="docfileedit" style="display:none;">
	             		<input type="file" name="twofile" id="twofile" keepdefaultstyle="true"  onchange="fileChange(this);" style="background:none;"/>
	             	</div>
	             </logic:notEmpty>
	             <logic:empty name="model" property="filepath">
	             		<input type="file" name="twofile" id="twofile" keepdefaultstyle="true"  onchange="fileChange(this);" style="background:none;"/>
	             </logic:empty>
                </p>
            </div>
            ...
            <div class="information_right_main_02">
            	<p style="padding-left:25px">申请状态：</p>
                <p>
            ...
            <div class="information_right_main_02">
            	<p style="padding-left:25px">驳回原因：</p>
                <p>
