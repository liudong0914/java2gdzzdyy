...
function goBack(){
	...
	}else if(${sys_userid eq student.userid}){
		location.href="/weixinHelp.app?method=myQuestion&userid=${userid}&menutype=${menutype}&pagenum=${pagenum}&questionid=${question.questionid}";
	}else{
		location.href="/weixinHelp.app?method=index&userid=${userid}&pagenum=${pagenum}&questionid=${question.questionid}";
	}
...
<div class="search">
    ...
    <div class="search_wk search_wk_answer">
        <%if(("0".equals(question.getReplystatus()) || "1".equals(question.getReplystatus())) && question.getMoney() > 0){ %>
...
<div class="class_main_student" id="div_one_1">
    ...
    <div class="answer_student_ygm">
    	<div class="answer_student_ygm_top">
            ...
            <%if(!"3".equals(question.getReplystatus()) && "1".equals(question.getStatus())){ %>
            <a href="/weixinHelp.app?method=complaint&userid=${userid }&questionid=${question.questionid }&orderid=${order.orderid }"><div class="answer_student_ygm_top_ts">
            	<img src="/weixin/images/ts.png" />
                <p>我要投诉</p>
            </div></a>
            <%} %>
...
<div class="" style="margin-top:15px;">   
<a href="/weixinHelp.app?method=beforeConfirmOrder&userid=${userid }&questionid=${question.questionid }&orderid=${order.orderid }" class="button" style="width:50%;right:0px;">确认答案付款</a>
</div>
<%
}}else{
%>
...
<div class="" style="margin-top:15px;">   
<a href="/weixinHelp.app?method=viewQuestionComplaint&userid=${userid }&questionid=${question.questionid }&orderid=${order.orderid }" class="Menubox01_button" style="background-color:#ccc;">已投诉，待受理。</a>
</div>
<%}else if("3".equals(question.getStatus())){ %>
<div class="" style="margin-top:15px;">   
<a href="/weixinHelp.app?method=viewQuestionComplaint&userid=${userid }&questionid=${question.questionid }&orderid=${order.orderid }" class="Menubox01_button" style="background-color:#ff0000;">投诉已被受理成功</a>
</div>
<%} %>
<script type="text/javascript">
$(function () {
