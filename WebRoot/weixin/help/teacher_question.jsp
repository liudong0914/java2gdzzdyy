...
function postData(){
	document.pageForm.action = "/weixinHelp.app?method=teacherAnswer&userid=${userid }";
...
<div class="Menubox">
    <ul>
        ...
        <a href="javascript:selectMenu(1)"><li style="width:20%;margin:0px 2%;" id="m1" <c:if test="${menutype eq '1'}">class="hover"</c:if>>我的回答</li></a>
...
<a href="/weixinHelp.app?method=index&userid=${userid}"  class="Menubox01_button">去《答疑中心》逛逛</a>
...
$(document).ready(function(){
	$(document).scroll(function(){
        ...
        if(scrolltop >= dheight-wheight){
    		  $.ajax({
		        type:"post",
		        url:"/weixinHelp.app?method=getAjaxTeacherQuestion",
