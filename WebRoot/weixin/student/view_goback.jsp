...
function goBack8(){
    ...
    <a href="javascript:goBack1();" class="footer_00">
    ...
    <a href="javascript:goBack2();" class="footer_00">
    	<img src="/weixin/images/wm.png" />
    	<p>返回</p>
    </a>
    <input type="hidden" name="bookcontentid" value="<bean:write name="bookcontentid"/>"/>
    ...
    <a href="javascript:goBack3();" class="footer_00">
    	<img src="/weixin/images/wm.png" />
    	<p>返回</p>
    </a>
    <input type="hidden" name="bookcontentid" value="<bean:write name="bookcontentid"/>"/>
    ...
    <a href="javascript:goBack4();" class="footer_00">
    	<img src="/weixin/images/wm.png" />
    	<p>返回</p>
    </a>
    <input type="hidden" name="bookcontentid" value="<bean:write name="bookcontentid"/>"/>
    ...
    <a href="javascript:goBack5();" class="footer_00">
    	<img src="/weixin/images/wm.png" />
    	<p>返回</p>
    </a>
    <input type="hidden" name="bookcontentid" value="<bean:write name="bookcontentid"/>"/>
    ...
    <a href="javascript:goBack6();" class="footer_00">
    	<img src="/weixin/images/wm.png" />
    	<p>返回</p>
    </a>
    <input type="hidden" name="bookcontentid" value="<bean:write name="bookcontentid"/>"/>
    ...
    <a href="javascript:goBack7();" class="footer_00">
    	<img src="/weixin/images/wm.png" />
    	<p>返回</p>
    </a>
    <input type="hidden" name="bookcontentid" value="<bean:write name="bookcontentid"/>"/>
    ...
    %>
    <a href="javascript:goBack8();" class="footer_00">
    	<img src="/weixin/images/wm.png" />
    	<p>返回</p>
    </a>
    <input type="hidden" name="bookcontentid" value="<bean:write name="bookcontentid"/>"/>
