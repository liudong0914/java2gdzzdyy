...
function preQuestion(){
	...
	document.pageForm.action = "/weixinStudent.app?method=viewSimilar";
...
<div id="container" style="padding-bottom:55px;">
	<div class="conrainer_bz">
    	<div class="container_bz_size">
    		<span>${index0 }.【<%=model.getQuestionno() %>】<%=model.getTitlecontent() %></span>
        </div>
    </div>
...
<div id="footer">
	...
	<a href="javascript:preQuestion()" class="footer_6">
	...
	<a href="javascript:nextQuestion()" class="footer_6">
