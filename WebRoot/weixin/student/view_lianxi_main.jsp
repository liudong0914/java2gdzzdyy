...
<iframe scrolling="auto" width="100%" height="500" frameBorder="0" id="frmmain" name="frmmain" src="/weixinStudent.app?method=viewLianxi&userid=${userid }&bookcontentid=${bookcontentid }&bookid=${bookid }&classid=${classid }&taskid=${taskid }&tasktype=${tasktype }&index=${index }&next=${next }" allowTransparency="true" onload="SetCwinHeight()"></iframe>
</body>
</html>