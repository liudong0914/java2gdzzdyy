...
function register(){
	...
	if(loginname == ""){
		document.getElementById("tips").innerHTML = "请填写用户名！";
		return;
	}
	...
	if(repassword != password){
		document.getElementById("tips").innerHTML = "确认密码输入错误！";
		return;
	}
	//点击支付弹出蒙板，避免重复点击
...
<div id="container">
    ...
    <div class="container_2">
    	<div class="container_2_size">
    		<input type="text" value="${username }" placeholder="真实姓名" name="username" id="username" class="container_2_input"/>
        </div>
    </div>
    <div class="container_2">
    	<div class="container_2_size">
    		<input type="text" value="${loginname }" placeholder="用户名" name="loginname" id="loginname" class="container_2_input"/>
        </div>
    </div>
    <div class="container_2">
    	<div class="container_2_size">
    		<input type="password" value="${password }" placeholder="密码" name="password" id="password" class="container_2_input"/>
        </div>
    </div>
    <div class="container_2">
    	<div class="container_2_size">
    		<input type="password" value="${repassword }" placeholder="确认密码" name="repassword" id="repassword" class="container_2_input"/>
        </div>
    </div>
    <%-- 
    <div class="container_2">
...
<input type="hidden" name="xueduan" id="xueduan" value="3"/>
</form>
</body>
</html>