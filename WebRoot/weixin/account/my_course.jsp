...
function setTab(c){
	...
	$.ajax({
		type:"post",
		url:"/weixinAccountIndex.app?method=getMyCourseByAjax",
		...
		success:function(data){
			if(data!=""){
				...
				$("#con").html("<div style='width:100%;background-color:#fff;text-align:center;height:85px;line-height:85px;'>尚未购买此类型微课</div>"); 
			}
			num++;
		}
	});
