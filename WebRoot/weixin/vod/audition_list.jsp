...
<script language="javascript" type="text/javascript">
			...
			$.ajax({
				...
				success:function(data){
					if(data!=""){
						...
						$("#filmcontent").html("<div style='width:100%;background-color:#fff;text-align:center;height:85px;line-height:85px;'>暂无试听微课</div>");
					}
					num++;
				}
			});
	...
	function postData(){
		document.pageForm.action = "/weixinVod.app?method=getFilmAuditionList&userid=${userid}";
