...
function postData(){
	document.pageForm.action = "/weixinVod.app?method=booklist&userid=${userid }";
...
<div class="class_main">
	...
	<%} %>
		<a href="/weixinVod.app?method=bookContentFilmList&userid=${userid }&bookid=<%=tbi.getBookid() %>">
