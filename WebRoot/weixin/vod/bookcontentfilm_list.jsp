...
function postData(){
	document.pageForm.action = "/weixinVod.app?method=bookContentFilmList&userid=${userid }&bookid=${bookid }";
...
<div class="search">
	<a href="/weixinVod.app?method=booklist&userid=${userid }"><div  class="search_left">
