...
<div id="container" style="padding-bottom:55px;">
    ...
    <div class="conrainer_button">
    	<%if(similarCounts.intValue() > 0){ %><a href="/weixinStudent.app?method=viewSimilar&userid=${userid }&bookcontentid=${bookcontentid }&bookid=${bookid }&classid=${classid }&index=${index }&next=${next }&show=1&qid=${model.questionid }&vtype=6" class="conrainer_button1">举一反三</a><%} %>
        <%if(filmCounts.intValue() > 0){ %><a href="/weixinStudent.app?method=videoPlay&userid=${userid }&bookcontentid=${bookcontentid }&bookid=${bookid }&classid=${classid }&index=${index }&next=${next }&show=1&qid=${model.questionid }&vtype=6" class="conrainer_button1">看微课</a><%} %>
    </div>
    <%} %>
...
<div id="footer">
	...
	<a href="/weixinTeacher.app?method=preparationQuestion&userid=${userid }&bookcontentid=${bookcontentid }&classid=${classid }&index=${index-1 }&next=-1&show=1&taskid=${taskid }&tasktype=${tasktype }" class="footer_6">
