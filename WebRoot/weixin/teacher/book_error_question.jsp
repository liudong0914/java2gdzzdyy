...
<div id="container_list" style="height:auto; padding-bottom: 0px;">
    ...
    <c:forEach items="${t.errorquestionlist }" var="e">
    	<div class="container_10">
				<div class="container_9_size">
					<a href="/weixinTeacher.app?method=detaiQuestion&questionid=${e.questionid }&userid=${userid}&bookcontentid=${t.bookcontentid}&classid=${classid}&type=3" class="container_7_size_moble">
						<div class="conrainer_9_moble_span">
