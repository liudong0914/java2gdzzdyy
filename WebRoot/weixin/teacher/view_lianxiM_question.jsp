...
<div id="container">
    ...
    <div class="conrainer_button">
    	<%if(similarCounts.intValue() > 0){ %><a href="/weixinStudent.app?method=viewSimilar&userid=${userid }&bookcontentid=${bookcontentid }&bookid=${bookid }&classid=${classid }&questionid=${model.questionid }&type=1&qid=${model.questionid }&vtype=9" class="conrainer_button1">举一反三</a><%} %>
        <%if(filmCounts.intValue() > 0){ %><a href="/weixinStudent.app?method=videoPlay&userid=${userid }&bookcontentid=${bookcontentid }&bookid=${bookid }&classid=${classid }&questionid=${model.questionid }&type=1&qid=${model.questionid }&vtype=9" class="conrainer_button1">看微课</a><%} %>
    </div>
    <%} %>
