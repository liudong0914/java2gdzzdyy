...
<div id="footer">
	...
	<a href="/weixinTeacher.app?method=preparationQuestion&userid=${userid }&bookcontentid=${bookcontentid }&classid=${classid }&index=${index-1 }&next=-1&show=1" class="footer_6">
