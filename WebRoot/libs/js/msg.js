...
Showbo.Msg={
    ...
    alert:function(msg){
      this.show({icon:'info',buttons:{yes:'确认'},msg:msg});
    },
    confirm:function(msg,fn){
      //fn为回调函数，参数和show方法的一致
      this.show({icon:'warning',buttons:{yes:'确认',no:'取消'},msg:msg,title:'提示',fn:fn});
    },
    ...
    show:function(cfg){
      ...
      if(cfg.wait){
        ...
        if(cfg.icon)this.dvCT.innerHTML='<div class="'+cfg.icon+'"></div>';
