...
<div class="box3" panelTitle="禁用用户" style="margin-right:0px;padding-right:0px;">
	<table>
		<tr>
			<td>登录名：</td>
...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="batchRecord('/sysUserInfoCheckAction.do?method=enableBatchRecord','确定要启用所选中用户?')"><span class="icon_ok">启用</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		...
		<tr>
			...
			<td class="ali02"><java2code:value codetype="status3" property="status" colorvalue="2"></java2code:value></td>
		</tr>
		</logic:iterate>
	</table>
</div>
