...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="addRecord('/sysUserInfoAction.do?method=beforeAdd')"><span class="icon_add">新增</span></a>
		<div class="box_tool_line"></div>
		<a href="javascript:;" onclick="batchRecord('/sysUserInfoAction.do?method=delBatchRecord','确定要禁用所选中用户?')"><span class="icon_no">禁用</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		...
		<tr>
			...
			<td class="ali02">
			<div class="img_edit hand" title="修改" onclick="editThisRecord('sysUserInfoAction.do','<bean:write name="model" property="userid"/>')"></div>
			<div class="img_user_worker hand" title="人员角色" onclick="addUserRole('<bean:write name="model" property="userid"/>')"></div>
			<div class="img_user_group hand" title="所属机构" onclick="addUserGroup('<bean:write name="model" property="userid"/>')"></div>
			</td>
		</tr>
		</logic:iterate>
	</table>
...
<script type="text/javascript">
	...
	function addUserRole(userid){
		...
		diag.Title = "人员角色";
		diag.URL = '/sysUserRoleAction.do?method=frame&userid='+userid;
		diag.Width = 380;
		diag.Height = 530;
	...
	function addUserGroup(userid){
		var diag = new top.Dialog();
		diag.Title = "所属机构";
		diag.URL = '/sysUnitDeptMemberAction.do?method=frame&userid='+userid;
		diag.Width = 380;
		diag.Height = 530;
		diag.ShowMaxButton=true;
		diag.show();
