...
<html:form action="/sysUserInfoAction.do" method="post">
	<table class="tableStyle" formMode="line" align="center">
		...
		<tr>
			...
			<td class="ali01"><input type="text" class="validate[required,length[0,25]]" name="sysUserInfo.loginname" value="<bean:write property="loginname" name="model"/>" readonly="readonly" style="background-image:none;background-color:#eee;border-color:#ccc;width:150px;"/><span class="star">*</span><span id="div_loginname" style="color:red;display:none;">此登录名已被其他用户注册!</span></td>
		...
		<tr>
			...
			<td class="ali01"><input type="password" style="width:150px;" name="password" id="password" value=""/><span class="star">*</span></td>
		</tr>
		<tr>
			<td class="ali03">确认密码：</td>
			<td class="ali01"><input type="password" style="width:150px;" name="passwordagain" id="passwordagain" value=""/><span class="star">*</span></td>
		</tr>
		<tr>
			<td class="ali03">&nbsp;</td>
		...
		<tr id="tr_studentno" <%if(!"2".equals(sui.getUsertype())){ %>style="display:none"<%} %>>
			...
			<td class="ali01"><input type="text" name="sysUserInfo.studentno" value="<bean:write property="studentno" name="model"/>" readonly="readonly" style="background-image:none;background-color:#eee;border-color:#ccc;"/><span id="div_studentno" style="color:red;display:none;">学号输入错误, 当前学号已存在!</span></td>
		</tr>
		...
		<tr>
			<td class="ali03">用户状态：</td>
			<td class="ali01"><java2code:option  name="sysUserInfo.status" codetype="status3" property="status" ckname="1"/></td>
		</tr>
		<tr>
...
function saveRecord(){
	if(validateForm('form[name=sysUserInfoActionForm]')){
		...
		var objectForm = document.sysUserInfoActionForm;
	  	objectForm.action="sysUserInfoCheckAction.do?method=<bean:write name="act"/>";
	  	objectForm.submit();
	}
}

function backRecord(){
  	document.sysUserInfoActionForm.action="/sysUserInfoCheckAction.do?method=list";
