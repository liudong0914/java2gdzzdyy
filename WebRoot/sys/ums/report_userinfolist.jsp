...
function report(){
	...
	document.pageForm.action = '/sysUmsUserInfoAction.do?method=reportUserInfoList&startTime='+startTime+'&endTime='+endTime;
...
<div class="box3" panelTitle="用户注册统计散点折线图" style="margin-right:0px;padding-right:0px;">
<table>
			<tr>
