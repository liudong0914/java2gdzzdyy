...
function report(){
	...
	document.pageForm.action = '/sysUmsUserInfoAction.do?method=reportUserMoneyList&startTime='+startTime+'&endTime='+endTime;
...
<div class="box3" panelTitle="用户交易统计散点折线图" style="margin-right:0px;padding-right:0px;">
<table>
			<tr>
...
<input type="hidden" id="name" value="4"/>
</div>
