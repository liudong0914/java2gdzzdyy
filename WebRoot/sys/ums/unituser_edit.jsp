...
<html:form action="/sysUmsUserInfoAction.do" method="post">
	<table class="tableStyle" formMode="line" align="center">
		...
		<tr>
			...
			<td class="ali01"><input type="text" class="validate[required,length[0,20]]" name="sysUserInfo.username" value="<bean:write property="username" name="model"/>"/><span class="star">*</span></td>
		</tr>	
		<tr>
		...
		<tr>
			...
			<td class="ali01"><input type="password" name="password" id="password" value=""/></td>
		</tr>
		<tr>
			<td class="ali03">确认密码：</td>
			<td class="ali01"><input type="password" name="passwordagain" id="passwordagain" value=""/></td>
		</tr>
		<tr>
			<td class="ali03">&nbsp;</td>
		...
		<tr>
			<td class="ali03">用户密码：</td>
			<td class="ali01"><input type="password" class="validate[required]" name="password" id="password" value=""/><span class="star">*</span></td>
		</tr>
		<tr>
			<td class="ali03">确认密码：</td>
			<td class="ali01"><input type="password" class="validate[required]" name="passwordagain" id="passwordagain" value=""/><span class="star">*</span></td>
		</tr>
		</logic:equal>
		  <%
		...
		<tr>
			...
			<td class="ali01"><input type="text" name="sysUserInfoDetail.cardno" value="<bean:write property="cardno" name="detail"/>"/></td>
		</tr>
		<tr>
			<td class="ali03">邮件地址：</td>
			<td class="ali01"><input type="text" class="validate[email]" name="sysUserInfo.email" value="<bean:write property="email" name="model"/>"/></td>
		</tr>
		<tr>
			<td class="ali03">QQ：</td>
			<td class="ali01"><input type="text" class="validate[qq]" name="sysUserInfoDetail.qq" value="<bean:write property="qq" name="detail"/>"/></td>
		</tr>
		<tr>
			<td class="ali03">MSN：</td>
			<td class="ali01"><input type="text" name="sysUserInfoDetail.msn" value="<bean:write property="msn" name="detail"/>"/></td>
		</tr>
		<tr>
			<td class="ali03">联系电话：</td>
			<td class="ali01"><input type="text" class="validate[telephone]" name="sysUserInfoDetail.telephone" value="<bean:write property="telephone" name="detail"/>"/></td>
		</tr>
		<%-- 
		<tr>
			<td class="ali03">手机号：</td>
			<td class="ali01"><input type="text" class="validate[mobilephone]" name="sysUserInfo.mobile" value="<bean:write property="mobile" name="model"/>"/></td>
		</tr>
		--%>
		<tr>
		...
		<tr>
			...
			<td class="ali01"><input type="text" style="width:255px;" name="sysUserInfoDetail.address" value="<bean:write property="address" name="detail"/>"/></td>
		</tr>
		<tr>
			<td class="ali03">个人简介：</td>
			<td class="ali01"><textarea name="sysUserInfoDetail.descript"><bean:write property="descript" name="detail"/></textarea></td>
		</tr>
...
function saveRecord(){
	if(validateForm('form[name=sysUserInfoActionForm]')){
		...
		if(selectCounty == ""){
			top.Dialog.alert("请选择籍贯!");
			return false;
		}
  
		var objectForm = document.sysUserInfoActionForm;
	  	objectForm.action="sysUmsUnitUserInfoAction.do?method=<bean:write name="act"/>";
	  	objectForm.submit();
	}
}
...
function backRecord(){
  	document.sysUserInfoActionForm.action="/sysUmsUnitUserInfoAction.do?method=list";
