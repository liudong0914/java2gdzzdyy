...
function report(){
	...
	document.pageForm.action = '/sysUmsUserInfoAction.do?method=reportUserlogList&startTime='+startTime+'&endTime='+endTime;
...
<div class="box3" panelTitle="用户使用统计散点折线图" style="margin-right:0px;padding-right:0px;">
<table>
			<tr>
...
<input type="hidden" id="name" value="2"/>
</div>
