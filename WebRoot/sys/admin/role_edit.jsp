...
<html:form action="/sysAdminRoleInfoAction.do" method="post">
...
function saveRecord(){
	if(validateForm('form[name=sysRoleInfoActionForm]')){
		var objectForm = document.sysRoleInfoActionForm;
	  	objectForm.action="sysAdminRoleInfoAction.do?method=<bean:write name="act"/>";
	  	objectForm.submit();
	}
}

function backRecord(){
  	document.sysRoleInfoActionForm.action="/sysAdminRoleInfoAction.do?method=list";
