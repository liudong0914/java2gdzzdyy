...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="addRecord('/sysAdminRoleInfoAction.do?method=beforeAdd')"><span class="icon_add">新增</span></a>
		<div class="box_tool_line"></div>
		<a href="javascript:;" onclick="delRecord('/sysAdminRoleInfoAction.do?method=delBatchRecord')"><span class="icon_delete">删除</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		...
		<tr>
			...
			<td class="ali02">
			<div class="img_edit hand" title="修改" onclick="editThisRecord('sysAdminRoleInfoAction.do','<bean:write name="model" property="roleid"/>')"></div>
...
<script type="text/javascript">
	...
	//提交表单
	function postData(){
	    document.pageForm.action = '/sysAdminRoleInfoAction.do?method=list';
	...
	function getRoleModule(roleid){
		...
		diag.Title = "角色模块";
		diag.URL = '/sysAdminRoleModuleAction.do?method=frame&roleid='+roleid;
		diag.Width = 380;
		diag.Height = 530;
	...
	function addUserRole(roleid){
		var diag = new top.Dialog();
		diag.Title = "角色人员";
		diag.URL = '/sysAdminUserRoleAction.do?method=main&roleid='+roleid;
		diag.Width = 800;
		diag.Height = 500;
