...
<script type="text/javascript">
	...
	function nextStep(){
		...
		if(userids==""){
			...
			location.href = '/sysMessageInfoAction.do?method=beforeSendContacts&userids='+userids;	
		}
	}
	//提交表单
	function postData(){
	    ...
	    document.pageForm.action = '/sysMessageInfoAction.do?method=userList&userids='+userids;
