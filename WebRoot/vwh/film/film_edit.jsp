...
<html:form action="/vwhFilmInfoAction.do" method="post">
	<table class="tableStyle" formMode="line" align="center">
		...
		<tr>
			...
			<td class="ali01" colspan="2"><input type="text" class="validate[required,onlyNumber]" name="vwhFilmInfo.orderindex" value="<bean:write property="orderindex" name="model"/>"/><span class="star">*</span></td>
		</tr>
        <tr>
...
function saveRecord(){
	if(validateForm('form[name=vwhFilmInfoActionForm]')){
		...
		keditor.sync();
	  	objectForm.action="vwhFilmInfoAction.do?method=<bean:write name="act"/>";
	  	objectForm.submit();
	}
}

function backRecord(){
  	document.vwhFilmInfoActionForm.action="/vwhFilmInfoAction.do?method=list";
