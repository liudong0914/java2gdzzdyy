...
<script type="text/javascript" src="/swfupload/js/swfupload/handlers_film2.js"></script>
<script type="text/javascript">
	var swfu;
	
	window.onload = function () {
		swfu = new SWFUpload({
			upload_url: "/fileUploadAction.do?ftag=vwhfilm&sketch=img&unitid=<%=session.getAttribute("s_unitid") %>",
			
			// File Upload Settings
			file_size_limit : "2048 MB",	// 100MB
			file_types : "*.bmp;*.jpg;*.tiff;*.gif;*.tga;*.exif;*.fpx;*.svg;*.psd;*.cdr;*.pcd;*.dxf;*.ufo;*.eps;*.ai;*.rm;*.raw;*.WMF;*.png",
...
<html:form action="/zxHelpOrderAction.do" method="post">
	<table id="infoTable" align="center" width="99%" border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
	  <tr>
	    <td width="60%" height="32" background="/swfupload/images/d11.gif" >&nbsp;你选择的图片</td>
	    <td width="16%" align="center" background="/swfupload/images/d11.gif" >图片大小</td>
	...
	<table class="tableStyle" formMode="line" align="center">
		...
		<p style="color: red">图片最多可以上传${num }张！</p>
	</table>	
