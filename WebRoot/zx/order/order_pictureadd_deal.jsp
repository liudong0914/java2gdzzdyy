...
<body>
<input type="hidden" name="uploadimageurl2" id="uploadimageurl2" value="<%=(String)request.getAttribute("fileIds")%>"/>
<input type="hidden" name="uploadimageurl3" id="uploadimageurl3" value="<%=(String)request.getAttribute("filenames")%>"/>
</body>
<script>
$(function(){
