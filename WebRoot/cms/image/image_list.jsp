...
<div class="box3" panelTitle="图片广告" style="margin-right:0px;padding-right:0px;">
	<table>
		<tr>
			<td>标题：</td>
...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="addRecord('/cmsImageInfoAction.do?method=beforeAdd')"><span class="icon_add">新增</span></a>
		<div class="box_tool_line"></div>
		<a href="javascript:;" onclick="delRecord('/cmsImageInfoAction.do?method=delBatchRecord')"><span class="icon_delete">删除</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		<tr>
			...
			<th class="ali02" width="100"><span onclick="sortHandler('sketch')" id="span_sketch">缩略图</span></th>
		...
		<tr>
			<td><input type="checkbox" name="checkid" value="<bean:write property="imageid" name="model"/>" <bean:write property="flags" name="model"/>/></td>
			<td class="ali01"><bean:write name="model" property="title"/></td>
			<td class="ali01">
			<center>
			<img src="/upload/<bean:write property="sketch" name="model"/>" width="107" height="57" border="1"/>
			</center>
			</td>
			...
			<td class="ali02">
			<div class="img_edit0 hand" title="修改" onclick="editThisRecord('cmsImageInfoAction.do','<bean:write name="model" property="imageid"/>')"></div>
			</td>
		</tr>
		</logic:iterate>
	</table>
...
<script type="text/javascript">
	...
	//提交表单
	function postData(){
	    document.pageForm.action = '/cmsImageInfoAction.do?method=list';
