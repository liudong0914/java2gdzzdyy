...
<html:form action="/cmsMyNewsInfoAction.do" method="post">
...
%>
	<table class="tableStyle" formMode="line" align="center">
		<tr>
			<th colspan="2"><logic:equal value="addSave" name="act">新增我的资讯</logic:equal><logic:equal value="updateSave" name="act">修改我的资讯</logic:equal></th>
		</tr>
		<tr>
...
function saveRecord(){
	if(validateForm('form[name=cmsNewsInfoActionForm]')){
		...
		keditor.sync();
	  	objectForm.action="cmsMyNewsInfoAction.do?method=<bean:write name="act"/>";
	  	objectForm.submit();
	}
}
