...
<%@page import="com.util.search.PageUtil"%>
...
<div class="box3" panelTitle="我的资讯" style="margin-right:0px;padding-right:0px;">
	<table>
		<tr>
			<td>资讯标题：</td>
			...
			<td>状态：</td>
			<td>
			    <select name="status" onchange="searchRecord()">
                     <option value="">全部</option>
                     <option value="0" <logic:equal value="0" name="status">selected=true</logic:equal>>待审核</option>
                     <option value="1" <logic:equal value="1" name="status">selected=true</logic:equal>>已审核</option>
                </select>
			</td>
...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="addRecord('/cmsMyNewsInfoAction.do?method=beforeAdd')"><span class="icon_add">新增</span></a>
		<div class="box_tool_line"></div>
		<a href="javascript:;" onclick="delRecord('/cmsMyNewsInfoAction.do?method=delBatchRecord')"><span class="icon_delete">删除</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		...
		<tr>
			<td><input type="checkbox" name="checkid" value="<bean:write property="newsid" name="model"/>" <bean:write property="flago" name="model"/>/></td>
			...
			<td class="ali02">
			<logic:equal property="status" name="model" value="0">
			    <div class="img_edit hand" title="修改" onclick="editThisRecord('cmsMyNewsInfoAction.do','<bean:write name="model" property="newsid"/>')"></div>
			</logic:equal>	
			<div class="img_find hand" title="详情" onclick="detail(${model.newsid})"></div>	
			</td>
		</tr>
		</logic:iterate>
	</table>
...
<script type="text/javascript">
	...
	//提交表单
	function postData(){
	    document.pageForm.action = '/cmsMyNewsInfoAction.do?method=list';
   		document.pageForm.submit();
	}
	function detail(id){
	    document.pageForm.action='/cmsMyNewsInfoAction.do?method=detail&id='+id;
	    document.pageForm.submit();   
	}
</script>
</body>
