...
<html:form action="/cmsNewsCheckAction.do" method="post">
...
%>
	<table class="tableStyle" formMode="line" align="center">
		...
		<tr>
		    ...
		    <td class="ali01"><java2code:option name="cmsNewsInfo.status" codetype="check" property="status" ckname="1"></java2code:option></td>
		</tr>
		<tr>
            <td class="ali03">资讯内容：</td>
            <td class="ali01" colspan="2"><textarea name="cmsNewsInfo.htmlcontent" style="width:600px;height:300px"><%=htmlspecialchars(model.getHtmlcontent())%></textarea></td>
        </tr>
			<td colspan="2">
...
function saveRecord(){
	if(validateForm('form[name=cmsNewsInfoActionForm]')){
		...
		keditor.sync();
	  	objectForm.action="cmsNewsCheckAction.do?method=<bean:write name="act"/>";
	  	objectForm.submit();
	}
}

function backRecord(){
  	document.cmsNewsInfoActionForm.action="/cmsNewsCheckAction.do?method=list";
