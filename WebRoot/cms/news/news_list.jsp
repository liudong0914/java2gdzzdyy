...
<div class="box3" panelTitle="资讯管理" style="margin-right:0px;padding-right:0px;">
	<table>
		<tr>
			<td>资讯标题：</td>
...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="addRecord('/cmsNewsInfoAction.do?method=beforeAdd')"><span class="icon_add">新增</span></a>
		<div class="box_tool_line"></div>
		<a href="javascript:;" onclick="delRecord('/cmsNewsInfoAction.do?method=delBatchRecord')"><span class="icon_delete">删除</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		<tr>
			...
			<th class="ali02" width="150"><span onclick="sortHandler('happendate')" id="span_happendate">日期</span></th>
		...
		<tr>
			...
			<td class="ali02">
			<div class="img_edit0 hand" title="修改" onclick="editThisRecord('cmsNewsInfoAction.do','<bean:write name="model" property="newsid"/>')"></div>
			</td>
		</tr>
		</logic:iterate>
	</table>
...
<script type="text/javascript">
	...
	//提交表单
	function postData(){
	    document.pageForm.action = '/cmsNewsInfoAction.do?method=list';
