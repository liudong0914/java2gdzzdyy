...
<div class="box3" panelTitle="课程用户管理" style="margin-right:0px;padding-right:0px;">
	<table>
		<tr>
			<td>登录名：</td>
...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="addRecord('/sysUmsUnitUserInfoAction.do?method=beforeAdd')"><span class="icon_add">新增</span></a>
		<div class="box_tool_line"></div>
		<a href="javascript:;" onclick="batchRecord('/sysUmsUnitUserInfoAction.do?method=delBatchRecord&setstatus=2','确定要禁用所选中用户?')"><span class="icon_no">禁用</span></a>
		<div class="box_tool_line"></div>
		<a href="javascript:;" onclick="batchRecord('/sysUmsUnitUserInfoAction.do?method=delBatchRecord&setstatus=1','确定要启用所选中用户？')"><span class="icon_ok">启用</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
...
<div>
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		<tr>
			...
			<th class="ali02" width="80"><span onclick="sortHandler('status')" id="span_status">用户状态</span></th>
			<th class="ali02" width="80"><span onclick="sortHandler('vip')" id="span_vip">是否为VIP</span></th>
		...
		<tr>
			...
			<td class="ali02">
				<input type="radio" name="eduCourseUser.vip" value="0" checked="checked"/>否&nbsp;
                <input type="radio" name="eduCourseUser.vip" value="1" />是&nbsp;
			</td>
			<td class="ali02">
			<div class="img_edit hand" title="修改" onclick="editThisRecord('sysUmsUnitUserInfoAction.do','<bean:write name="model" property="userid"/>')"></div>
			</td>
		</tr>
		</logic:iterate>
	</table>
...
<script type="text/javascript">
	...
	//提交表单
	function postData(){
	    document.pageForm.action = '/sysUmsUnitUserInfoAction.do?method=list';
