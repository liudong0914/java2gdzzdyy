...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		<tr>
			...
			<th class="ali02" width="120"><span onclick="sortHandler('columnno')" id="span_columnno">课程编号</span></th>
...
<script type="text/javascript">
	...
	//提交表单
	function postData(){
	    document.pageForm.action = '/eduCourseInfoAction.do?method=viewColumn&courseid='+${courseid};
