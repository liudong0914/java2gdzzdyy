...
<div class="box3" panelTitle="学段管理" style="margin-right:0px;padding-right:0px;">
	<table>
		<tr>
			<td>学段名称：</td>
...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right0">
	...
	<div class="right">
		...
		<a href="javascript:;" onclick="addRecord('/eduXueduanInfoAction.do?method=beforeAdd')"><span class="icon_add">新增</span></a>
		<div class="box_tool_line"></div>
		<a href="javascript:;" onclick="delRecord('/eduXueduanInfoAction.do?method=delBatchRecord')"><span class="icon_delete">删除</span></a>
		<div class="clear"></div>
		</div>
	</div>		
	</div>	
...
<div id="scrollContent" >
	<table class="tableStyle" useClick="false" useCheckBox="true" sortMode="true">
		<tr>
			<th width="25"></th>
			<th class="ali02"><span onclick="sortHandler('name')" id="span_name">学段名称</span></th>
			<th class="ali02" width="150"><span onclick="sortHandler('orderindex')" id="span_orderindex">排序</span></th>
		...
		<tr>
			<td><input type="checkbox" name="checkid" value="<bean:write property="xueduanid" name="model"/>" <bean:write property="flags" name="model"/>/></td>
			...
			<td class="ali02">
			<div class="img_edit0 hand" title="修改" onclick="editThisRecord('eduXueduanInfoAction.do','<bean:write name="model" property="xueduanid"/>')"></div>
			</td>
		</tr>
		</logic:iterate>
	</table>
...
<script type="text/javascript">
	...
	//提交表单
	function postData(){
	    document.pageForm.action = '/eduXueduanInfoAction.do?method=list';
