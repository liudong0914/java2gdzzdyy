...
<ul class="kecheng">
	...
	<li><a href="javascript:toOnclick('<bean:write name="model" property="gradeid"/>')" title='<bean:write name="model" property="gradename"/>'><bean:write name="model" property="gradename"/></a></li>
    </logic:iterate>
    <div class="clear"></div>
</ul>
</form>
...
function toOnclick(gradeid){
	document.pageForm.action = 'eduSelectAction.do?method=deal&tag=selectgrade&objid=' + gradeid;
